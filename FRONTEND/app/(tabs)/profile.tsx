...
export default function Profile() {
  ...
  const loadAccessUsers = useCallback(async () => {
    try {
      const result = await api<AccessUser[]>("/access-users");
      setAccessUsers(Array.isArray(result) ? result : []);
    } catch (error) {
      console.error("Fehler beim Laden der Zugangsprofile:", error);
      setAccessUsers([]);
    }
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {canAccessWounds && (
          <>
            <SectionTitle title="Wundversorgung" />

            <Pressable
              onPress={() => router.push("/wound-documentation" as any)}
              style={styles.woundButton}
            >
              <View style={styles.woundButtonIcon}>
                <Ionicons
              ...
              <View style={styles.flexOne}>
                <Text style={styles.woundButtonTitle}>
                  Wunddokumentation
                </Text>

                <Text style={styles.woundButtonText}>
                  Wunde erfassen, Foto dokumentieren, Verlauf beurteilen
                  und zuständige PFK, Arzt sowie Wundmanager zuordnen.
                </Text>
              </View>
        ...
        <SectionTitle
          ...
          onAction={
            canManageProfiles
              ? () => router.push("/add-relative" as any)
              : undefined
          }
        />
        ...
        <SectionTitle
          ...
          onAction={
            canManageProfiles
              ? () => router.push("/add-caregiver" as any)
              : undefined
          }
        />
